...
#[test]
fn mermaid_showcase_flow_basic_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_snapshot(&mut screen, 80, 24, "mermaid_showcase_flow_basic_80x24");
}

#[test]
fn mermaid_showcase_flow_basic_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_snapshot(&mut screen, 120, 40, "mermaid_showcase_flow_basic_120x40");
}
...
fn mermaid_showcase_flow_basic_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_snapshot(&mut screen, 200, 60, "mermaid_showcase_flow_basic_200x60");
}

#[test]
fn mermaid_showcase_flow_basic_ascii_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    ...
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_flow_basic_ascii_80x24",
    );
}
...
fn mermaid_showcase_flow_basic_ascii_120x40() {
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_flow_basic_ascii_120x40",
    );
}

#[test]
fn mermaid_showcase_flow_basic_ascii_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_flow_basic_ascii_200x60",
    );
}

#[test]
fn mermaid_showcase_flow_dense_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 2);
    mermaid_showcase_snapshot(&mut screen, 80, 24, "mermaid_showcase_flow_dense_80x24");
}
...
fn mermaid_showcase_sequence_mini_120x40() {
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_sequence_mini_120x40",
    );
}
...
fn mermaid_showcase_sequence_mini_200x60() {
    ...
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_sequence_mini_200x60",
    );
}

#[test]
fn mermaid_showcase_sequence_mini_ascii_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 6);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_sequence_mini_ascii_80x24",
    );
}

#[test]
fn mermaid_showcase_sequence_mini_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 6);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_sequence_mini_ascii_120x40",
    );
}

#[test]
fn mermaid_showcase_sequence_mini_ascii_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 6);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_sequence_mini_ascii_200x60",
    );
}
...
#[test]
fn mermaid_showcase_class_basic_ascii_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 9);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_class_basic_ascii_80x24",
    );
}

#[test]
fn mermaid_showcase_class_basic_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 9);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_class_basic_ascii_120x40",
    );
}

#[test]
fn mermaid_showcase_class_basic_ascii_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 9);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_class_basic_ascii_200x60",
    );
}

#[test]
fn mermaid_showcase_panels_collapsed_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    screen.update(&press(KeyCode::Char('m')));
    screen.update(&press(KeyCode::Char('c')));
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_panels_collapsed_120x40",
    );
}

#[test]
fn mermaid_showcase_viewport_override_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    screen.update(&press(KeyCode::Char(']')));
    screen.update(&press(KeyCode::Char(']')));
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_viewport_override_120x40",
    );
}
...
fn mermaid_showcase_gitgraph_basic_120x40() {
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_gitgraph_basic_120x40",
    );
}

#[test]
fn mermaid_showcase_gitgraph_basic_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 19);
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_gitgraph_basic_200x60",
    );
}

#[test]
fn mermaid_showcase_gitgraph_basic_ascii_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 19);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_gitgraph_basic_ascii_80x24",
    );
}

#[test]
fn mermaid_showcase_gitgraph_basic_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 19);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_gitgraph_basic_ascii_120x40",
    );
}

#[test]
fn mermaid_showcase_gitgraph_basic_ascii_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 19);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_gitgraph_basic_ascii_200x60",
    );
}
...
fn mermaid_showcase_journey_basic_120x40() {
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_journey_basic_120x40",
    );
}

#[test]
fn mermaid_showcase_journey_basic_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 20);
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_journey_basic_200x60",
    );
}
...
fn mermaid_showcase_journey_basic_ascii_80x24() {
    ...
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_journey_basic_ascii_80x24",
    );
}
...
fn mermaid_showcase_journey_basic_ascii_120x40() {
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_journey_basic_ascii_120x40",
    );
}

#[test]
fn mermaid_showcase_journey_basic_ascii_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 20);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_journey_basic_ascii_200x60",
    );
}
...
fn mermaid_showcase_requirement_basic_80x24() {
    ...
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_requirement_basic_80x24",
    );
}
...
fn mermaid_showcase_requirement_basic_120x40() {
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_requirement_basic_120x40",
    );
}
...
#[test]
fn mermaid_showcase_requirement_basic_ascii_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 21);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_requirement_basic_ascii_80x24",
    );
}

#[test]
fn mermaid_showcase_requirement_basic_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 21);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_requirement_basic_ascii_120x40",
    );
}

#[test]
fn mermaid_showcase_requirement_basic_ascii_200x60() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 21);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        200,
        60,
        "mermaid_showcase_requirement_basic_ascii_200x60",
    );
}
...
fn mermaid_showcase_block_beta_basic_80x24() {
    ...
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_block_beta_basic_80x24",
    );
}
...
fn mermaid_showcase_block_beta_basic_120x40() {
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_block_beta_basic_120x40",
    );
}

#[test]
fn mermaid_showcase_block_beta_basic_ascii_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 22);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        80,
        24,
        "mermaid_showcase_block_beta_basic_ascii_80x24",
    );
}

#[test]
fn mermaid_showcase_block_beta_basic_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 22);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_block_beta_basic_ascii_120x40",
    );
}
...
fn mermaid_showcase_block_beta_nested_120x40() {
    ...
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_block_beta_nested_120x40",
    );
}

#[test]
fn mermaid_showcase_block_beta_nested_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen = ftui_demo_showcase::screens::mermaid_showcase::MermaidShowcaseScreen::new();
    mermaid_showcase_goto_sample(&mut screen, 23);
    screen.update(&press(KeyCode::Char('g')));
    mermaid_showcase_snapshot(
        ...
        120,
        40,
        "mermaid_showcase_block_beta_nested_ascii_120x40",
    );
}
...
fn mega_showcase_flow_basic_80x24() {
    ...
    mega_showcase_snapshot(&mut screen, 80, 24, "mega_showcase_flow_basic_80x24");
}

#[test]
fn mega_showcase_flow_basic_ascii_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    screen.update(&press(KeyCode::Char('g')));
    mega_showcase_snapshot(&mut screen, 80, 24, "mega_showcase_flow_basic_ascii_80x24");
}

#[test]
fn mega_showcase_flow_basic_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
...
#[test]
fn mega_showcase_flow_basic_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    screen.update(&press(KeyCode::Char('g')));
    mega_showcase_snapshot(
        ...
        120,
        40,
        "mega_showcase_flow_basic_ascii_120x40",
    );
}
...
#[test]
fn mega_showcase_sequence_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    mega_showcase_goto_sample(&mut screen, 3);
...
#[test]
fn mega_showcase_sequence_ascii_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    mega_showcase_goto_sample(&mut screen, 3);
    screen.update(&press(KeyCode::Char('g')));
    mega_showcase_snapshot(&mut screen, 80, 24, "mega_showcase_sequence_ascii_80x24");
}

#[test]
fn mega_showcase_sequence_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    mega_showcase_goto_sample(&mut screen, 3);
    screen.update(&press(KeyCode::Char('g')));
    mega_showcase_snapshot(&mut screen, 120, 40, "mega_showcase_sequence_ascii_120x40");
}
...
#[test]
fn mega_showcase_class_ascii_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    mega_showcase_goto_sample(&mut screen, 4);
    screen.update(&press(KeyCode::Char('g')));
    mega_showcase_snapshot(&mut screen, 120, 40, "mega_showcase_class_ascii_120x40");
}
...
#[test]
fn mega_showcase_help_overlay_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    screen.update(&press(KeyCode::Char('?')));
...
#[test]
fn mega_showcase_collapsed_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    screen.update(&press(KeyCode::Escape));
    mega_showcase_snapshot(&mut screen, 120, 40, "mega_showcase_collapsed_120x40");
}

// Viewport override with custom size.
#[test]
fn mega_showcase_viewport_override_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    screen.update(&press(KeyCode::Char(']')));
...
// ============================================================================
// Mermaid Mega Showcase — Sequence Diagrams (bd-2kn9a)
// ============================================================================

#[test]
fn mega_showcase_sequence_loops_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
...
#[test]
fn mega_showcase_sequence_loops_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    mega_showcase_goto_sample(&mut screen, 16);
...
#[test]
fn mega_showcase_sequence_parallel_80x24() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
...
#[test]
fn mega_showcase_sequence_parallel_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
    mega_showcase_goto_sample(&mut screen, 17);
    mega_showcase_snapshot(
        ...
        120,
        40,
        "mega_showcase_sequence_parallel_120x40",
    );
}

#[test]
fn mega_showcase_sequence_dense_120x40() {
    let _guard = ScopedThemeLock::new(ThemeId::CyberpunkAurora);
    let mut screen =
        ftui_demo_showcase::screens::mermaid_mega_showcase::MermaidMegaShowcaseScreen::new();
